...
from utils import hwc_to_chw, read_img,read_img_grey
...
class PairLoader(Dataset):
	...
	def __getitem__(self, idx):
		...
		source_img = read_img_grey(os.path.join(self.root_dir, 'gray', img_name)) * 2 - 1
		...
		return {'target': hwc_to_chw(target_img),'source':hwc_to_chw(source_img), 'filename': img_name}
